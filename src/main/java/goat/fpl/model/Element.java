...
public class Element {
    ...
    private long loaned_in;
    private long loaned_out;
    private long loans_in;
    private long loans_out;
    private int minutes;
    private String news;
    ...
    public long getLoaned_in() {
	return loaned_in;
    }

    public long getLoaned_out() {
	return loaned_out;
    }

    public long getLoans_in() {
	return loans_in;
    }

    public long getLoans_out() {
	return loans_out;
    }
    ...
    public void setLoaned_in(long loaned_in) {
	this.loaned_in = loaned_in;
    }

    public void setLoaned_out(long loaned_out) {
	this.loaned_out = loaned_out;
    }

    public void setLoans_in(long loans_in) {
	this.loans_in = loans_in;
    }

    public void setLoans_out(long loans_out) {
	...
	return "Element{" + "id=" + id + ", web_name='" + web_name + '\'' + '}';
    }
}
